<div class="vidio-loop-style3-wrap-ele ele grid gap-12">
	<?php
	...
	if ($sec_hook->have_posts()) : while($sec_hook->have_posts()) : $sec_hook->the_post();
		...
		$love_count = awetube_get_love_count( get_the_ID() );

	?>
	<div class="vidio-item-wrap">
		<div class="vidio-item">
			...
			<div class="vidio-detail">
				...
				<?php if($use_view == 'on') { ?>
				<div class="meta-video-wrap grid grid-cols-12">
					<div class="viewers col-span-4">
						<i class="fa fa-eye"></i>
						<p><?php 
					...
					<div class="dots col-span-4">
						<div class="dot"></div>
					</div>
					<div class="like col-span-4">
						<i class="fa fa-heart"></i><p><?php echo esc_html( $love_count ); ?></p>
					</div>
				</div>
				<?php } ?>
			</div>
